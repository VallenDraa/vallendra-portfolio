...
export default function NavbarComponent() {
  ...
  return (
    <div
      ref={navbarRef}
      className="sticky top-0 z-[70] min-w-full animate-fade-in-bottom rounded-none border-0 bg-indigo-100/50 py-3 px-0 backdrop-blur-md dark:bg-gray-800/50"
    >
      <div className="mx-auto flex max-w-screen-xl items-center justify-between px-8 text-indigo-500 dark:text-gray-200 2xl:px-0">
        {/* name section */}
