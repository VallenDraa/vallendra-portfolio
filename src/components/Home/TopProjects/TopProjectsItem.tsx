  ...
  return (
    <div
      className={clsx(
        ...
        isLast && "border-b-2",
        twistDirection !== "left"
          ? "border-l-2 pr-3 before:absolute before:inset-y-0 before:left-0 before:z-50 before:mx-auto before:hidden before:w-12 before:border-l-2 before:border-indigo-300/70 dark:before:border-white/40 lg:w-full lg:flex-row-reverse lg:justify-end lg:rounded-l-xl lg:border-0 lg:border-l-0 lg:before:left-1/2 lg:before:block lg:before:-translate-x-1/2 before:lg:rounded-bl-2xl lg:before:rounded-tl-2xl"
          : clsx(
    ...
    >
      ...
      <Show when={isFirst}>
        <div className="absolute -top-3 left-0 right-[calc(50%-1px)] block h-3.5 bg-[#E9EDFF] dark:bg-[#1E1E21] lg:hidden" />
      </Show>

      {/* div to hide the bottom-right border for smaller screen */}
      <Show when={isLast}>
        <div className="absolute -bottom-3 left-[calc(50%-1px)] right-0 block h-3.5 bg-[#E9EDFF] dark:bg-[#1E1E21] lg:hidden" />
      </Show>
      ...
      <div
        className={clsx(
          ...
          "relative z-40 flex basis-1/2 items-center pb-8 pt-2 transition duration-500 lg:p-0",
        )}
      >
        <div
          className={clsx(
          ...
          <div className="flex flex-col">
            ...
            <StyledButton
              ...
              className={clsx(
                "relative",
                "!text-indigo-400",
                !projectIsInView && "pointer-events-none",
                "mt-2 flex w-full items-center justify-center gap-2 self-start px-4 py-3 lg:w-max",
                "border !border-indigo-400  hover:bg-indigo-500/10",
              )}
            >
              See Project
            </StyledButton>
