...
export default function Redirect() {
  return (
    <section className="relative z-30 mx-auto flex h-[full] max-w-screen-xl flex-col items-center px-2 py-24 lg:px-8 xl:px-0">
      <Line className="absolute top-5 left-1/2 z-40 -translate-x-1/2 scale-y-[3]" />

      <Typography
        as="h2"
        className="pt-4 text-4xl font-bold text-indigo-500 dark:text-gray-200 md:text-5xl lg:text-6xl"
      >
        Wanna Work Together ?
      </Typography>
