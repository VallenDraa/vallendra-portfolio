    ...
    <>
      ...
      >
        <div className="mx-auto flex max-w-screen-xl flex-col items-center justify-center px-8 lg:px-2 xl:min-h-[650px] xl:flex-row xl:justify-between 2xl:px-0">
          ...
          <Observe
            freezeOnceVisible
            enterCB={(ref) => fadeIn(ref, "animate-fade-in-left")}
          >
          ...
          <div className="relative">
            ...
            <div aria-label="name-section">
              <Observe
                freezeOnceVisible
                enterCB={(ref) => fadeIn(ref, "animate-fade-in-top", 50)}
              >
                <Typography
                  as="span"
                  variant="h3"
              ...
              <Observe
                freezeOnceVisible
                enterCB={(ref) => fadeIn(ref, "animate-fade-in-top", 350)}
              >
                <Typography
                  as="h1"
                  variant="h1"
              ...
              <Observe
                freezeOnceVisible
                enterCB={(ref) => fadeIn(ref, "animate-fade-in-top", 650)}
              >
                <Typography
                  as="span"
                  variant="h3"
