    ...
    >
      {({ open }) => (
        <>
          ...
          >
            <Popover.Panel className="absolute right-0 z-30 mt-4 w-full origin-top space-y-4 rounded-md bg-indigo-50 p-5 shadow-md shadow-indigo-300 focus-visible:outline-none dark:bg-zinc-800 dark:shadow-zinc-800 md:w-[500px] md:origin-top-right">
