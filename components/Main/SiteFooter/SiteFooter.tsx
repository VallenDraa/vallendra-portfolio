...
export default function SiteFooter() {
  return (
    <footer className="bg-gray-900 relative">
      ...
      <div className="max-w-screen-2xl px-8 py-8 mx-auto flex flex-col lg:flex-row justify-between items-center gap-5 relative z-40">
        <div className="flex items-center justify-center lg:justify-start gap-2 grow">
          <Link
